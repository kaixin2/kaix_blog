...
(function (mod) {
    ...
    CodeMirror.defineMode("xquery", function () {
        ...
        var keywords = function () {
            ...
            // each axis_specifiers will add a property to kwObj with value of {type: "axis_specifier", style:
            // "qualifier"}
        ...
        function tokenBase(stream, state) {
            ...
            // close paren
                ...
                // if the next non whitespace character is an open paren, this is probably a function (if not a keyword
                // of other sort)
                if (stream.match(/^[ \t]*\(/, false)) {
                ...
                // as previously checked, if the word is element,attribute, axis specifier, call it an "xmlconstructor"
                // and push the stack so we know to look for it on the next word
