...
public class RedisKeyUtil {
    ...
    private static final String PREFIX_REGISTER = "register";//用户产生要注册的用户的激活码的获取键

    public static String getRegisterKey(String userName, String password, String email) {
        return PREFIX_REGISTER + userName + password + email;
    }
